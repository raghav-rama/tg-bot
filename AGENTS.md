...
- Treat text replies, `/image`-driven generated image replies, and `/video` or `/video_ltx` generated video replies as the only supported outputs unless the docs in this repo are updated.
